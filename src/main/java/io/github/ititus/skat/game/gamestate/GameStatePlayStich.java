...
public class GameStatePlayStich extends GameState {

    GameStatePlayStich(GamePhase phase, ReizState reizState, GameRules rules, Player[] activePlayers,
                       ScoreBoard scoreBoard, Stich currentStich, Stich lastStich, byte stichNum, Player alleinspieler,
    ...
    static GameState create(int cardNum, SkatClient client, NetworkGameState networkGameState) {
        return null;
    }
