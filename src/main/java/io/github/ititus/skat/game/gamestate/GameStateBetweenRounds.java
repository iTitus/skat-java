...
public class GameStateBetweenRounds extends GameState {
    ...
    GameStateBetweenRounds(GamePhase phase, ReizState reizState, GameRules rules, Player[] activePlayers,
                           ScoreBoard scoreBoard, Stich currentStich, Stich lastStich, byte stichNum,
                           Player alleinspieler, boolean tookSkat, CardCollection hand, Player player, Player partner) {
